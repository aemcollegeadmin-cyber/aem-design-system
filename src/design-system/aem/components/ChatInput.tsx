...
export const ChatInput = forwardRef<HTMLInputElement, ChatInputProps>(function ChatInput(
  ...
  return (
    <div className={cn("flex items-center gap-2 rounded-card border-2 border-border-strong bg-surface px-4 py-2 shadow-card transition-colors hover:border-ink focus-within:border-ink", className)}>
      <input
        ref={ref}
