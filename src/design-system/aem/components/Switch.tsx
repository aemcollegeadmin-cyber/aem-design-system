...
export const Switch = forwardRef<HTMLButtonElement, SwitchProps>(function Switch(
  ...
  return (
    <Root
      ref={ref}
      className={cn(
        "inline-flex h-6 w-11 shrink-0 items-center rounded-pill bg-surface-muted p-0.5 transition-colors data-[state=checked]:bg-ink disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
