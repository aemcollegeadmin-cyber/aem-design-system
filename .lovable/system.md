...
- Один епізод — контрол «Показати епізоди» не показується, епізод видно
  одразу. PodcastCard автоматично прибирає `title` у єдиного `EpisodeRow`, щоб
  не дублювати назву картки. Згортання з'являється від двох епізодів.
