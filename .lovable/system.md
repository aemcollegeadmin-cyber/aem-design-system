...
- Розміри фіксовані: sm 16, md 20, lg 24, xl 32. **sm і md завжди рендеряться залитими (filled)** — 2px штрих на малих розмірах виглядає надто важким. lg і xl — outline зі сталим штрихом 2px (`absoluteStrokeWidth`).
